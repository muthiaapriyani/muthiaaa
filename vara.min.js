"use strict"; function _typeof(a) {
    "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator?function(a) {
        return typeof a
    }:function(a) {
        return a && "function" == typeof Symbol && a.constructor === Symbol && a !== Symbol.prototype?"symbol": typeof a
    },
    _typeof(a)}var Vara = function(a, b, c, d) {
    var e = this; this.elementName = a,
    this.textsInit = [],
    "string" == typeof c?this.textsInit.push({
        text: c
    }): "object" == _typeof(c) && (this.textsInit = c),
    ...
    b.send(null)}, Vara.prototype.preCreate = function() {(function() {
    ...
    this.space = {
        ...
        for (var c = [], d = "string" == typeof this.texts[b]? {
            text: this.texts[b]}: this.texts[b], e = d.text, f = 0; f < e.length; f++) {
            var g = e[f]; if (0 < a.breakPoints[b][f].length)for (var h, i, l = a.breakPoints[b][f].length, m = 0; m <= l; m++) {
                i = a.breakPoints[b][f][m],
                a.breakPoints[b][f][l-1] != g.length && a.breakPoints[b][f].push(g.length); var n = null == a.breakPoints[b][f][m-1]?0: a.breakPoints[b][f][m-1]; h = g.slice(n, i).replace(/^\s+/g, ""),
                c.push(h)} else c.push(e[f])}this.texts[b].text = c
